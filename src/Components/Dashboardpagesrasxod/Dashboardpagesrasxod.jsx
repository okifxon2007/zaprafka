        ...
        <table className="min-w-full bg-white border border-gray-200 rounded-lg">
          <thead>
            <tr className="bg-blue-600 text-white">
              ...
              <th className="py-3 px-4 text-left">SABAB</th>
          ...
          <tbody>
            {[
              { name: "mam", amount: 200000, reason: "as", time: "Feb. 20, 2025" },
            ].map((item, index) => (
              <tr
                key={index}
...
export default Dashboardpagesrasxod;